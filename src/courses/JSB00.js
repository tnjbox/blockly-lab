...
const normalizeExamples = (overrides, merged) => {
  if (Array.isArray(overrides.examples)) return overrides.examples;
...
export const JSB00 = {
  ...
  type: 'programming',
  description:
    '以 Google Blockly 原生積木練習輸出、輸入、變數、運算與條件判斷，並使用 testCases 進行本機系統評分。',
  level: '國中初階',
  ...
  tasks: [
    cloneTask(base, {
      ...
      examples: [
        { input: '無輸入', output: 'Hello world', explanation: '程式直接輸出 Hello world。' },
      ],
    ...
    cloneTask(base, {
      ...
      examples: [
        { input: '無輸入', output: '一起學習吧', explanation: '程式直接輸出指定文字。' },
      ],
    ...
    cloneTask(base, {
      ...
      examples: [
        { input: '10\n20', output: '30', explanation: '第一行輸入 10，第二行輸入 20，10+20=30。' },
        { input: '7\n8', output: '15', explanation: '第一行輸入 7，第二行輸入 8，7+8=15。' },
      ],
      testCases: [
        { input: '10\n20', output: '30' },
        { input: '7\n8', output: '15' },
      ...
      challenge: '改成三個數字相加。',
      starterXml: promptTwoNumberSumXml(),
    ...
    cloneTask(base, {
      ...
      title: '兩數平均',
      goal: '練習輸入、加總與除法。',
      description: '讀取兩個數字並輸出平均值。',
      problemStatement: '請設計一個程式，第一行輸入整數 A，第二行輸入整數 B，輸出 A 與 B 的平均值。',
      inputDescription: '第一行輸入整數 A。第二行輸入整數 B。',
      outputDescription: '輸出 (A+B)/2 的結果；本題測資皆可整除，不會出現小數。',
      examples: [
        { input: '80\n90', output: '85', explanation: '(80+90)/2=85。' },
        { input: '10\n30', output: '20', explanation: '(10+30)/2=20。' },
      ],
      testCases: [
        { input: '80\n90', output: '85' },
        { input: '10\n30', output: '20' },
      ...
      practiceTask: '先完成加總，再除以 2。',
      functionTask: '進階可整理成 average(a, b) 函式。',
      challenge: '若平均值不是整數，改為輸出小數。',
      starterXml: hintXml('提示：讀取 A 與 B，輸出 (A+B)/2。'),
      starterMessage: '已載入 JSB00-04：兩數平均。',
    }),
    cloneTask(base, {
      id: 'JSB00-05',
      title: '比較大小',
      ...
      examples: [
        { input: '17\n25', output: 'B', explanation: '17 小於 25，因此輸出 B。' },
        { input: '30\n30', output: 'SAME', explanation: '兩個數字相同，因此輸出 SAME。' },
      ],
      testCases: [
        { input: '17\n25', output: 'B' },
        { input: '30\n30', output: 'SAME' },
    ...
    cloneTask(base, {
      ...
      examples: [
        { input: '24', output: 'EVEN', explanation: '24 可以被 2 整除，因此輸出 EVEN。' },
        { input: '15', output: 'ODD', explanation: '15 除以 2 餘 1，因此輸出 ODD。' },
      ],
      testCases: [
      ...
      starterMessage: '已載入 JSB00-06：判斷奇偶數。',
    }),
    cloneTask(base, {
      id: 'JSB00-07',
      title: '成績等第',
      ...
      examples: [
        { input: '92', output: 'A', explanation: '92 大於等於 90，因此輸出 A。' },
        { input: '75', output: 'C', explanation: '75 大於等於 70 且未達 80，因此輸出 C。' },
      ],
      testCases: [
        { input: '92', output: 'A' },
        { input: '85', output: 'B' },
      ...
      starterMessage: '已載入 JSB00-07：成績等第。',
    }),
    cloneTask(base, {
      id: 'JSB00-08',
      title: '台斤公斤大PK',
      goal: '練習單位換算與數字運算。',
      description: '將台斤換算成公斤。',
      problemStatement: '請設計一個程式，輸入台斤數 J，輸出對應的公斤數。已知 1 台斤 = 0.6 公斤。',
      inputDescription: '第一行輸入一個整數 J，代表台斤數。',
      outputDescription: '輸出 J*0.6 的結果；本題測資輸出皆為整數。',
      examples: [
        { input: '10', output: '6', explanation: '10 台斤等於 6 公斤。' },
        { input: '25', output: '15', explanation: '25 台斤等於 15 公斤。' },
      ],
      testCases: [
        { input: '10', output: '6' },
        { input: '25', output: '15' },
      ...
      demoObserve: '觀察乘法運算與單位換算。',
      practiceTask: '讀取 J 後輸出 J*0.6。',
      functionTask: '進階可整理成 jinToKg(j) 函式。',
      challenge: '改成公斤轉台斤。',
      starterXml: hintXml('提示：讀取台斤數 J，輸出 J*0.6。'),
      starterMessage: '已載入 JSB00-08：台斤公斤大PK。',
    }),
  ],
};
